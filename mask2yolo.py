# EX: python mask2yolo.py --input="./datasets/mask/mask_dataset1/" --output="./outputs/yolo_dataset1"
# EX: python mask2yolo.py --input="./datasets/mask/mask_dataset2/" --output="./outputs/yolo_dataset2"
...
mask2yolo(input_directory, output_directory)
