...
import argparse
# Args
# EX: python3 mask2labelme.py --input="./datasets/mask/dataset_name" --output="./outputs/labelme_dataset"
# EX: python3 mask2labelme.py --input="./datasets/mask/isic2018/" --output="./outputs/labelme_dataset"
# EX: python mask2labelme.py --input="./datasets/mask/dataset_masks" --output="./outputs/labelme_outputs"
...
# 設定目錄與參數
# dataset_dir = "./datasets/mask/dataset_masks"
# output_dir = "./outputs/labelme_outputs"
...
mask2labelme(dataset_dir, output_dir, label_names)
